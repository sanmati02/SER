...
add_arg('save_matrix_path', str,   'output/images/',         "Path to save the confusion matrix")
add_arg('resume_model',     str,   'models/StackedLSTMAdditiveAttention_CustomFeature/best_model/',  "Path to the pretrained model")
